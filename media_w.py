...
for position in w:
	f.write(user + ": w1 = "+position[0][0]+" w-1 = "+position[0][1] +" | correto importante = "+ str("%.2f"%(position[1][0]/count[(position[0][0],position[0][1])][0])) +"%"
	" | correto nao-importante = "+str("%.2f"%(position[1][1]/count[(position[0][0],position[0][1])][1]))+"%"
	" | falso positivo = "+str("%.2f"%(position[1][2]/count[(position[0][0],position[0][1])][2]))+"%"
	" | falso negativo= "+str("%.2f"%(position[1][3]/count[(position[0][0],position[0][1])][3]))+"%\n")
